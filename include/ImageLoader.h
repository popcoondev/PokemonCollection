...
public:
  ...
  bool loadAndDisplayPNGPath(lgfx::LGFXBase& target, const char* path, int16_t x, int16_t y,
                             uint16_t maxW, uint16_t maxH, bool drawErrorOnFailure = true);
...
private:
  ...
  bool loadAndDisplayPNGInternal(lgfx::LGFXBase& target, const char* path, int16_t x, int16_t y,
